        ...
        <section id="contact" className="py-[var(--spacing-xl)] px-[var(--spacing-base)] bg-[var(--color-background)]">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[var(--spacing-lg)]">
                    <div className="p-[var(--spacing-lg)] border border-[var(--color-border)] rounded-[var(--radius-xl)] text-center hover:shadow-[var(--shadow-lg)] transition-shadow">
                        <div className="w-14 h-14 bg-[var(--color-neutral-100)] rounded-[var(--radius-full)] mx-auto mb-[var(--spacing-base)] flex items-center justify-center">
                        ...
                        <h3 className="text-[var(--font-size-lg)] font-[var(--font-weight-semibold)] mb-[var(--spacing-sm)]">
                            Email
                        </h3>
