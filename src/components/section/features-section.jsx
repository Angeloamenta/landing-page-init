        ...
        <section id="features" className="py-[var(--spacing-xl)] px-[var(--spacing-base)]">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[var(--spacing-lg)]">
                    <div className="p-[var(--spacing-lg)] border border-[var(--color-border)] rounded-[var(--rounded-xl)] hover:shadow-lg transition-shadow">
                        <div className="w-12 h-12 bg-[var(--color-neutral-100)] rounded-[var(--rounded-lg)] mb-6 flex items-center justify-center">
                            <svg className="w-6 h-6 text-[var(--color-neutral-700)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                        </div>
                        <h3 className="text-xl font-[var(--font-weight-bold)] mb-3">
                            Feature 1
                        </h3>
